...
router.post("/", restaurant_controller_1.addRestaurant);
router.put("/:id", restaurant_controller_1.updateRestaurant);
router.delete("/:id", restaurant_controller_1.removeRestaurant);
